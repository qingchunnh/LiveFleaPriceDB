...
const main = (async () => {
    ...
    if (!DEBUG)
    {
        ...
        await downloadFile('https://raw.githubusercontent.com/sp-tarkov/server/refs/heads/3.10.3-DEV/project/assets/database/templates/handbook.json', 'akihandbook.json');
        ...
        await downloadFile('https://raw.githubusercontent.com/sp-tarkov/server/refs/heads/3.10.3-DEV/project/assets/database/templates/prices.json', 'akiprices.json');
    }
